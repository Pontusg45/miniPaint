...
class Tools_settings_class {
	...
	settings() {
		...
		let enable_autoresize = this.get_setting("enable_autoresize");
		...
		let settings = {
			...
			on_finish: function (params: { theme: number | boolean; transparency: number | boolean; transparency_type: number | boolean; snap: number | boolean; guides: number | boolean; safe_search: number | boolean; exit_confirm: number | boolean; default_units: string | number | boolean; resolution: number | boolean; thick_guides: number | boolean; enable_autoresize: number | boolean; }) {
