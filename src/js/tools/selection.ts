...
let instance: Selection_class | null = null;
...
class Selection_class extends Base_tools_class {
	...
	GUI_tools: GUI_tools_class | null = null;
	Base_selection: Base_selection_class | null = null;
	ctx: CanvasRenderingContext2D | undefined = undefined;
	name: string | undefined;
	type!: string | null;
	tmpCanvas!: HTMLCanvasElement | null;
	tmpCanvasCtx!: CanvasRenderingContext2D | null;
	selection_coords_from: any;
